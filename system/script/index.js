	...
	if (!pms || !this.isValidUrl(self.plex.getServerUrl())) {
		...
		self.plex.checkLibraryServerExists(function(xml) {
			...
			self.plex.getSections(function(xml) {
				...
				$("#sections ul").append("<li><a data-key-index=\"" + (i+3) + "\" data-title=\"shared\" data-key=\"shared\" data-section-type=\"shared\" data-art=\"" + self.plex.getTranscodedPath("/:/resources/movie-fanart.jpg", 1280, 720) + "\" href>Shared</a></li>");
